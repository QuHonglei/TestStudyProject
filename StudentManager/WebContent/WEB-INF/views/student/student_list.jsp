	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'username',title:'学号',width:100, sortable: true},
 		       ...
 		       //遍历班级id并转换为班级名称
 		        ...
 		        {field:'year',title:'入学年份',width:60, sortable: true},
 		       	{field:'endyear',title:'毕业年份',width:60, sortable: true},
 		       	{field:'province',title:'所属省份',width:80, sortable: true},
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    //设置分页控件 
	    ...
	    $("#addDialog").dialog({
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_year").textbox('setValue',selectRow.year);
				$("#edit_password").textbox('setValue', selectRow.password);
				$("#edit_endyear").textbox('setValue', selectRow.endyear);
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			学号：<input id="search-name" class="easyui-textbox" />
			所属班级：
		...
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="addTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="photo-preview" alt="照片" style="max-width: 60px; max-height: 60px;" title="照片" src="/StudentManager/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<input type="hidden" name="password" id="add-password" value="111111">
	    	<table id="addTable2" cellpadding="8">
	    		...
	    		<tr >
	    			<td>学号:</td>
	    			<td>
	    				<input id="add_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请填写学号'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生姓名:</td>
	    		...
	    		<tr >
	    			<td>入学年份:</td>
	    			<td>
	    				<input id="add_year"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="year" data-options="required:true, missingMessage:'请填写入学年份'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>所属省份:</td>
	    			<td>
	    				<input id="add_province"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="province" data-options="required:true, missingMessage:'请填写所属省份：'"  />
	    			</td>
	    		</tr>
	    	</table>
	    </form>
    	...
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
	    	<table id="editTable1" cellpadding="8">
	    		<tr >
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="edit-photo-preview" alt="照片" style="max-width: 60px; max-height: 60px;" title="照片" src="/StudentManager/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生头像:</td>
   		...
   		<form id="editForm" method="post">
	    	...
	    	<table id="editTable2" cellpadding="8">
	    		...
	    		<tr >
	    			<td>学号:</td>
	    			<td>
	    				<input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, missingMessage:'请填写学号'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>学生姓名:</td>
	    		...
	    		<tr >
	    			<td>入学年份:</td>
	    			<td>
	    				<input id="edit_year"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="year" data-options="required:true, missingMessage:'请填写入学年份'"  />
	    			</td>
	    		</tr>
	    		<tr >
	    			<td>所属省份:</td>
	    			<td>
	    				<input id="edit_province"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="province" data-options="required:true, missingMessage:'请填写所属省份：'"  />
	    			</td>
	    		</tr>
	    	</table>
	    </form>
