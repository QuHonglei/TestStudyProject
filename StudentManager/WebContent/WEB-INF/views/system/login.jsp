...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    ...
    <div class="row cl" style="padding: 0;">
	<h2 style="color: white;line-height: 0px; margin: 0 0 0 195px; padding: 0;">学生信息管理系统</h2>
	</div>
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=4&w=120&h=40"></div>
      </div>
...
<div class="footer" >Copyright &nbsp;@2021 Beichen </div>
